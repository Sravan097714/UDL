        ...
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            dataitem(PageLoop; "Integer")
            {
                ...
                dataitem(Total; "Integer")
                {
                    ...
                    begin
                        ...
                        //Message('%1', TextInWords[1] + TextInWords[2]);
                    end;
                }
            }
            ...
            begin
                ...
                if "Vendor Ledger Entry"."Currency Code" <> '' then
                    CurrCode := "Vendor Ledger Entry"."Currency Code"
                else
                    CurrCode := 'MUR';
                "Vendor Ledger Entry".CalcFields("Original Amount");
                Check.InitTextVariable;
                Check.FormatNoText2(TextInWords, ABS("Vendor Ledger Entry"."Original Amount"), "Vendor Ledger Entry"."Currency Code");
