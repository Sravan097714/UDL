report 50027 "Payment Receipt for Vendors"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\RemittanceAdvice2.rdl';
    ...
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            dataitem(PageLoop; "Integer")
            {
                ...
                column(PostingDate; Format("Vendor Ledger Entry"."Posting Date", 0, 4)) { }
                column(gtextPaymentMethod; "Vendor Ledger Entry"."Payment Method Code") { }
            ...
            begin
                ...
                if grecPaymentMethod.get("Vendor Ledger Entry"."Payment Method Code") then
                    gtextPaymentMethod := grecPaymentMethod.Description;

                Check.InitTextVariable;
                Check.FormatNoText2(TextInWords, "Vendor Ledger Entry"."Original Amount", '');
            end;
    ...
    var
        ...
        Check: Report "Check Laser printer";
        ...
        Text004: Label 'Remittance Voucher';
